                    ...
                    <div className="modal-header">
                        {editing && (
                            <button
                                ...
                                type="button" className="btn btn-secondary" onClick={handleBackButtonClick}>
                                <i className="fas fa-arrow-left text-dark"></i>
                            </button>
                        )}
                        <h5 className="modal-title text-center" id="personalInfoModalLabel">Thông tin cá nhân</h5>
                        <button
                    ...
                    <div className="modal-body position-relative">
                                    ...
                                    <div
                                        ...
                                        <label htmlFor="avatar" className="form-label position-relative">
                                            ...
                                            <img
                                                ...
                                                src={avatarPicture} className="rounded-circle img-thumbnail" alt="Avatar" id="avatarPreview" />
                                        </label>
                        ...
                        {hasTransitionedIn || editing ? (
                            ...
                            <div
                                ...
                                <div className='' style={{ height: "5px", margin: "0 -16px 15px -16px", background: '#eef0f1' }}>
                                ...
                                <h3
                                    ...
                                    className="text-left mb-4">Thông tin cá nhân</h3>
                                <p className='p_infor'><strong className='me-3'>Giới tính:</strong> <span>{gender ? "nữ" : "nam"}</span></p>
                                <p className='p_infor'><strong className='me-3'>Ngày sinh:</strong> <span>12-2-2024</span></p>
                                <p className='p_infor'><strong className='me-3'>Số điện thoại:</strong> <span> {phonenumber}</span></p>
                            </div>
                        )}
                    </div>
