    ...
    return (
        <div id="chat_container" className={clsx('position-relative', !view.chat ? 'd-none' : '')}>
            {isOpenModalCreateGroup.group && (
                <ModalCreateGroup
                    onHide={() => {
                        setIsOpenModalCreateGroup({ ...isOpenModalCreateGroup, group: false });
                    }}
                    group={conversation.recieveInfor}
                />
            )}
            {isOpenModalCreateGroup.user && (
                <ModalCreateGroup
                    onHide={() => {
                        setIsOpenModalCreateGroup({ ...isOpenModalCreateGroup, user: false });
                    }}
                    user={conversation.recieveInfor}
                />
            )}
            ...
            <div className="chat_input_container bg-white">
                ...
                <div className="chat_input position-relative">
                    {isOpenSticker && <EmojiPicker onEmojiClick={handleIconMessage} />}
                    <input
                        ref={refInput}
                        type="text"
                        placeholder="Aa"
